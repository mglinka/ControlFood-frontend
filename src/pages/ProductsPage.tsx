        ...
        <div className="p-6">
            ...
            {selectedProduct && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div
                        className="bg-white p-6 rounded-lg shadow-lg w-[90%] max-w-md sm:max-w-lg md:max-w-3xl lg:max-w-4xl max-h-[90vh] overflow-y-auto relative"
                    >
                        {/* Przycisk zamykania */}
                        <button
                            onClick={closeModal}
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            {/* Sekcja lewa: Zdjęcie i informacje o produkcie */}
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            {bgColor !== 'bg-gray-500' && (
                                                                ...
                                                                >
                                                                    Intensywność {intensity === 'low' ? 'niska' : intensity === 'medium' ? 'średnia' : 'wysoka'}
                                                                </div>
                                                            )}
                                                        </div>
                                                    );
                            ...
                            {/* Sekcja prawa: Tabela wartości odżywczych */}
                            <div className="flex-1">
